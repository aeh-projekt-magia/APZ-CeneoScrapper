...
# user_product_subscription2 = db.Table('user_product_subscription2',
...
# #     subscriptions = relationship('Products', secondary=user_product_subscription2, back_populates='subscribers')
